               ...
               if(bt_Motors_Enabled)                                          // Run motors only if enabled
               {
                  if(bt_2_S_Time_Up)                                          // Update drive state after 2 seconds
                  {
                     ...
                     switch(uc_Drive_Index)                                   // Cycle through drive states
                     {
                        case 0: // Stop
                        {
                           ui_PotClawSetpoint1 = 1750;
                           ui_PotClawSetpoint2 = 625;
                           Bot.ToPosition("S1", ui_PotClawSetpoint1);
                           Bot.ToPosition("S2", ui_PotClawSetpoint2);                                     // Drive ID
                        ...
                        {
                           ui_PotClawSetpoint1 = 718;
                           ui_PotClawSetpoint2 = 1680;
                           Bot.ToPosition("S1", ui_PotClawSetpoint1);
                        ...
                        {
                           ui_PotClawSetpoint1 = 1425;
                           ui_PotClawSetpoint2 = 975;
                           Bot.ToPosition("S1", ui_PotClawSetpoint1);
                           Bot.ToPosition("S2", ui_PotClawSetpoint2);
                        ...
                        case 5:
                        {
                          ui_PotClawSetpoint1 = 1230;
                           ui_PotClawSetpoint2 = 1170;
                           Bot.ToPosition("S1", ui_PotClawSetpoint1);
                           Bot.ToPosition("S2", ui_PotClawSetpoint2);
